...
class FoodTruck < ApplicationRecord
  ...
  CATEGORIES = {
    ...
    'Pastries and Desserts' => %w[pastries croissants dessert sweets ice cream waffle cones flan cobbler donuts muffins],
    'Vegan' => %w[vegan],
    ...
    'Various Foods' => %w[food various many different chicken rotisserie mexican brazilian indian latin peruvian pizza chili]
    }.freeze
